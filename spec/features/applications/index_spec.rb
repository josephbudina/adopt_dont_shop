...
#       @jeff = @pet1.applications.create!(name: "Jeff", street_address: "123 Shady Ave", city: "Denver", state: "CO", zip: 80011, applicant_discription: "This is a test 1", pet_names: "Fluffy, Dan", status: "In Progress")
